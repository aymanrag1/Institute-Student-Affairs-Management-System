...
spl_autoload_register( function ( string $class ): void {
    ...
    $map = [
        ...
        'Modules\\Library_Transactions'=> 'includes/modules/class-library-transactions.php',
        'Modules\\Library_Orders'      => 'includes/modules/class-library-orders.php',
        'Modules\\Library_Reports'     => 'includes/modules/class-library-reports.php',
...
function rsyi_sa_admin_assets( string $hook ): void {
    ...
    // Enqueue WP Media library on settings page (logo uploader) and exams page (question images)
    if ( strpos( $hook, 'rsyi-settings' ) !== false || strpos( $hook, 'rsyi-exams' ) !== false ) {
        wp_enqueue_media();
    }
    wp_enqueue_style(
        'rsyi-sa-admin',
